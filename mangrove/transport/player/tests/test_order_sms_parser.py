...
class TestOrderSMSParser(unittest.TestCase):
    ...
    def test_should_return_all_answers(self):
        ...
        with patch("mangrove.transport.player.parser.SMSParser.get_form_code_and_tokens") as mock_get_form_code_and_tokens:
            mock_get_form_code_and_tokens.return_value = 'questionnaire_code', ['q1_answer', 'q2_answer', 'q3_answer']
    ...
    def test_should_return_extra_data_with_answers(self):
        ...
        self._mock_get_question_codes_from_couchdb(['q1', 'q2', 'q3'])
        with patch("mangrove.transport.player.parser.SMSParser.get_form_code_and_tokens") as mock_get_form_code_and_tokens:
            mock_get_form_code_and_tokens.return_value = 'questionnaire_code', ['q1_answer', 'q2_answer', 'q3_answer', "extra1", "extra2", "extra3"]
            values = self.sms_parser.parse(message)
            question_code_and_answers = {"q1": "q1_answer", "q2": "q2_answer", "q3": "q3_answer"}
