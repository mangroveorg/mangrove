...
def create_question_from(dictionary, dbm):
    ...
    if type == field_attributes.TEXT_FIELD:
        return _get_text_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    if type == field_attributes.BOOLEAN_FIELD:
        return _get_boolean_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    if type == field_attributes.TIME:
        return _get_time_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    if type == field_attributes.DATE_TIME:
        return _get_date_time_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.INTEGER_FIELD:
        return _get_integer_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.DATE_FIELD:
        return _get_date_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.LOCATION_FIELD:
        return _get_geo_code_field(code, instruction, label, name, required, parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.SELECT_FIELD or type == field_attributes.MULTISELECT_FIELD:
        return _get_select_field(code, dictionary, label, name, type, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.LIST_FIELD:
        return _get_list_field(name, code, label, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.TELEPHONE_NUMBER_FIELD:
        return _get_telephone_number_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.SHORT_CODE_FIELD:
        return _get_short_code_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
        ...
        return _get_unique_id_field(unique_id_type, code, dictionary, label, name, instruction, required,
                                    parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.FIELD_SET:
        return _get_field_set_field(code, dictionary, label, name, instruction, required, dbm, parent_field_code, hint, constraint_message, appearance, default)
    elif type == field_attributes.PHOTO or type == field_attributes.VIDEO or type == field_attributes.AUDIO:
        return _get_media_field(type, code, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default)
...
def _get_media_field(type, code, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
...
def _get_field_set_field(code, dictionary, label, name, instruction, required, dbm, parent_field_code, hint, constraint_message, appearance, default):
...
def _get_text_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
    constraints, constraints_json = [], dictionary.get("constraints")
    if constraints_json is not None:
        constraints = constraints_factory(constraints_json)
...
def _get_boolean_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
    constraints, constraints_json = [], dictionary.get("constraints")
    if constraints_json is not None:
        constraints = constraints_factory(constraints_json)
...
def _get_time_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
    constraints, constraints_json = [], dictionary.get("constraints")
    if constraints_json is not None:
        constraints = constraints_factory(constraints_json)
    field = TimeField(name=name, code=code, label=label,
                      constraints=constraints, instruction=instruction, required=required,
                      parent_field_code=parent_field_code, hint=hint, constraint_message=constraint_message, appearance=appearance, default=default)
    return field


def _get_date_time_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
    constraints, constraints_json = [], dictionary.get("constraints")
    if constraints_json is not None:
        constraints = constraints_factory(constraints_json)
...
def _get_short_code_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
    constraints, constraints_json = [], dictionary.get("constraints")
    if constraints_json is not None:
        constraints = constraints_factory(constraints_json)
    field = ShortCodeField(name=name, code=code, label=label,
                           constraints=constraints, instruction=instruction, required=required,
                           parent_field_code=parent_field_code, hint=hint, appearance=appearance, constraint_message=constraint_message, default=default)
    return field


def _get_unique_id_field(unique_id_type, code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
    return UniqueIdField(unique_id_type=unique_id_type, name=name, code=code,
                         ...
                         xform_field_reference=dictionary.get("xform_field_reference"), hint=hint, constraint_message=constraint_message, appearance=appearance, default=default)


def _get_telephone_number_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
    constraints, constraints_json = [], dictionary.get("constraints")
    if constraints_json is not None:
        constraints = constraints_factory(constraints_json)
...
def _get_integer_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
...
def _get_date_field(code, dictionary, label, name, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
...
def _get_select_field(code, dictionary, label, name, type, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
    ...
    field = SelectField(name=name, code=code, label=label, options=choices, single_select_flag=single_select,
                        instruction=instruction, required=required, parent_field_code=parent_field_code,
                        has_other=dictionary.get("has_other"), hint=hint, constraint_message=constraint_message, appearance=appearance, default=default)

    return field


def _get_list_field(name, code, label, instruction, required, parent_field_code, hint, constraint_message, appearance, default):
...
def _get_geo_code_field(code, instruction, label, name, required, parent_field_code, hint, constraint_message, appearance, default):
...
class Field(object):
    def __init__(self, type="", name="", code="", label='', instruction='',
                 constraints=None, required=True, parent_field_code=None, hint=None, constraint_message=None, appearance=None, default=None):
...
class DateField(Field):
    ...
    def __init__(self, name, code, label, date_format, instruction=None,
                 required=True, parent_field_code=None, hint=None, constraint_message=None, appearance=None, default=None):
...
class TextField(Field):
    ...
    def __init__(self, name, code, label, constraints=None, defaultValue="", instruction=None,
                 required=True, parent_field_code=None, is_calculated=False, hint=None, constraint_message=None, appearance=None, default=None):
        if not constraints: constraints = []
...
class UniqueIdField(Field):
    def __init__(self, unique_id_type, name, code, label, constraints=None, defaultValue=None, instruction=None,
                 required=True, parent_field_code=None, xform_field_reference=None, hint=None, constraint_message=None, appearance=None, default=None):
        if not constraints: constraints = []
        assert isinstance(constraints, list)
...
class UniqueIdUIField(UniqueIdField):
    def __init__(self, field, dbm):
        super(UniqueIdUIField, self).__init__(unique_id_type=field.unique_id_type, name=field.name, code=field.code,
                                              ...
                                              constraints=field.constraints, parent_field_code=field.parent_field_code, hint=field.hint, constraint_message=field.constraint_message, appearance=field.appearance, default=field.default)
        self.dbm = dbm
...
class ShortCodeField(TextField):
    def __init__(self, name, code, label, constraints=None, defaultValue=None, instruction=None,
                 required=False, parent_field_code=None, hint=None, constraint_message=None, appearance=None, default=None):
        if not constraints:
...
class SelectField(Field):
    ...
    def __init__(self, name, code, label, options, instruction=None,
                 single_select_flag=True, required=True, parent_field_code=None, has_other=False, hint=None, constraint_message=None, appearance=None, default=None):
...
class GeoCodeField(Field):
    ...
    def __init__(self, name, code, label, instruction=None, required=True, parent_field_code=None, hint=None, constraint_message=None, appearance=None, default=None):
...
class VideoField(MediaField):
    def __init__(self, name, code, label, instruction=None, required=True, parent_field_code=None, hint=None, constraint_message=None, appearance=None, default=None):
        MediaField.__init__(self, type=field_attributes.VIDEO, name=name, code=code, label=label,
                            instruction=instruction,
                            required=required, parent_field_code=parent_field_code, hint=hint, constraint_message=constraint_message, appearance=appearance, default=default)
