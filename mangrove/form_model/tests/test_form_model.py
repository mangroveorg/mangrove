...
from mangrove.contrib.registration_validators import MobileNumberValidationsForReporter
...
class FormModelTest(MangroveTestCase):
    ...
    def test_should_save_form_model_with_validators(self):
        ...
        form = FormModel(self.manager, 'test_form', 'label', 'foo', fields=fields, entity_type=['Clinic'],
            validators=[MandatoryValidator(), MobileNumberValidationsForReporter()])
        form.save()
        ...
        self.assertTrue(isinstance(form.validators[1], MobileNumberValidationsForReporter))
