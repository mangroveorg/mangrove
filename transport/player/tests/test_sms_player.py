...
class TestSMSPlayer(TestCase):
    def setUp(self):
        ...
        self.request = Request(transport="sms", message="FORM_CODE +ID 1 +M hello world", source="1234",
                               destination="5678")
    ...
    def test_should_not_parse_if_two_question_codes(self):
        self.request = Request(transport="sms", message="cli001 +na tester1 +na tester2", source="1234",
                               destination="5678")
